...
INSERT INTO usuario (rol, nombre, correo, contrasena, creado_at, actualizado_at)
VALUES
    ('GERENTE', 'Gerente General', 'gerente@vcsystems.com', '$2a$10$Tz6kjklzzInH.CfH8wF.L8l5YfM8N44lDt0U0vFzZhUmP4J0W5gW6', NOW(6), NOW(6)),
    ('TECNICO', 'Técnico Soporte', 'tecnico@vcsystems.com', '$2a$10$K0.DUZZ7j2e8ebzLjjje8OBdBpMv51tqaFswbJYbzy.kFkNxzA9W6', NOW(6), NOW(6)),
    ('CLIENTE', 'Cliente Demo', 'cliente@empresa.com', '$2a$10$O.mU2R5..pLnnFzRI5CIxuB7QlrID5cmkOe.N1g7aBgJ3J8b5m/gq', NOW(6), NOW(6));

INSERT INTO cliente (id_usuario, nombre_empresa, direccion_empresa, creado_at, actualizado_at)
VALUES (3, 'Empresa Demo S.A.C.', 'Av. Principal 123, Lima', NOW(6), NOW(6));

INSERT INTO proveedor (nombre, telefono, contacto, direccion, creado_at, actualizado_at)
VALUES
...
INSERT INTO diccionario_fallas (codigo_falla, descripcion, creado_at, actualizado_at)
VALUES
...
INSERT INTO incidencia (id_cliente, id_tecnico, id_falla, descripcion, estado, prioridad, fecha_creacion, creado_at, actualizado_at)
VALUES
...
INSERT INTO solicitud_repuesto (id_incidencia, id_proveedor, id_tecnico, justificacion, estado, creado_at, actualizado_at)
VALUES
...
DELETE FROM usuario WHERE contrasena = 'password123';
-- pruebitas
SHOW TABLES;
